...
- **Number of BGP Sessions Up** - Number of BGP sessions on the router that are up.
 ...
 [<img src='./img/router-number-of-sessions-up.png' width=200px>](./img/router-number-of-sessions-up.png)
...
[<img src='./img/container-memory-utilization-percent.png' width=200px>](./img/container-memory-utilization-percent.png)
