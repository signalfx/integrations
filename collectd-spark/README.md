...
- **Spark Cluster**: Overview of data from all RabbitMQ nodes.
...
- **Spark Cluster Instance**: Overview of data from all RabbitMQ nodes.
...
- **Master Process**: Overview of data from all RabbitMQ nodes.
...
- **Worker Process**: Overview of data from all RabbitMQ nodes.
...
- **Spark Application**: Overview of data from all RabbitMQ nodes.
