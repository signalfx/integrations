...
To monitor the general health of ActiveMQ, see [SignalFx's ActiveMQ integration](../collectd-activemq)[](sfx_link:collectd-activemq).

#### FEATURES

##### Built-in dashboards (accompanying [SignalFx's ActiveMQ integration](../collectd-activemq)[](sfx_link:collectd-activemq))
...
This tool provides visibility into "stuck" messages in ActiveMQ by inspecting each enqueued message, calculating the average and maximum age of messages per queue, and reporting those metrics to SignalFx using our [Java client library](../lib-java). 
