...
Monitor average background flush time and the most recent background flush time with gauge.backgroundFlushing.average\_ms and gauge.backgroundFlushing.last\_ms respectively.
