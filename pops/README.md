...
| `DATA_SINK_DP_ENDPOINT` | The  datapoint endpoint POPS will forward  datapoints to. | `https://ingest.{realm}.signalfx.com/v2/datapoint` | `DATA_SINK_DP_ENDPOINT=https://ingest.{realm}.signalfx.com/v2/datapoint` |
| `DATA_SINK_EVENT_ENDPOINT` | The event endpoint POPS will forward events to. | `https://ingest.{realm}.signalfx.com/v2/event`  | `DATA_SINK_EVENT_ENDPOINT=https://ingest.{realm}.signalfx.com/v2/event` |
...
| `SF_METRICS_STATSENDPOINT` | The ingest url for emitting internal metrics about POPS .| `https://ingest.{realm}.signalfx.com/v2/datapoint` | `SF_METRICS_STATSENDPOINT=https://ingest.{realm}.signalfx.com/v2/datapoint` |
