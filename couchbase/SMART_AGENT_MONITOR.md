...
as the `collectd/couchbase` monitor. To set up the integration, perform the following steps:
1. Deploy the Smart Agent to the same host as the service you want to monitor.
2. Continue with the configuration instructions below.
